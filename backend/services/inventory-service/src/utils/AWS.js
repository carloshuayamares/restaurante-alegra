...
const sendMessageSQS = async (data, group) => {
    const sqs = new AWS.SQS();
    // Configura los parámetros para enviar el mensaje
    const params = {
        MessageBody: JSON.stringify({ ...data, texto: "Este es un mensaje a una cola FIFO" }), // Mensaje en formato JSON
...
const receiveMessageSQS = async () => {
    ...
    const params = {
        ...
        WaitTimeSeconds: 5, // Long polling para optimizar el consumo de mensajes
    };
